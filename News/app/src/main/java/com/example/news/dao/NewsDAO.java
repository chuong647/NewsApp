...
public class NewsDAO {
    ...
    private SQLiteDatabase db; //khai bao csdl
    ...
    //phuong thuc capnhat hang moi vao csdl
    public boolean update(News news) {
        ContentValues values = new ContentValues();//chen 1 hang moi vao ban csdl
        ...
        try {
            ...
            return false;// them k thanh cong
        }
    }
    //phuong thuc xoa
    public boolean delete(int id){
        ...
        return false;//xoa k thanh cong
    }
    //khai bao thuoc tinh co ten getAll
    public List<News> getALL(){
        String sql = "SELECT * FROM "+TABLE_NAME;
        return getData(sql);
    }
    //truy cap News thong qua 1 id voi kieu int
